...
final class NXHashState public constructor(/*0*/ rawPtr: kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */): kotlinx.cinterop.CStructVar(TODO() as kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */) {
    final var i: kotlin.Int
        get() = TODO()
        set(value: kotlin.Int) = TODO()

    final var j: kotlin.Int
        get() = TODO()
        set(value: kotlin.Int) = TODO()
...
final class NXHashTable public constructor(/*0*/ rawPtr: kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */): kotlinx.cinterop.CStructVar(TODO() as kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */) {
    final var buckets: kotlinx.cinterop.COpaquePointer? /* = kotlinx.cinterop.CPointer<out kotlinx.cinterop.CPointed>? */
        get() = TODO()
        set(value: kotlinx.cinterop.COpaquePointer? /* = kotlinx.cinterop.CPointer<out kotlinx.cinterop.CPointed>? */) = TODO()

    final var count: kotlin.UInt
        get() = TODO()
    ...
    final var nbBuckets: kotlin.UInt
        get() = TODO()
        set(value: kotlin.UInt) = TODO()

    final var prototype: kotlinx.cinterop.CPointer<platform.objc.NXHashTablePrototype>?
        get() = TODO()
        set(value: kotlinx.cinterop.CPointer<platform.objc.NXHashTablePrototype>?) = TODO()

    companion object Companion: kotlinx.cinterop.CStructVar.Type(TODO() as kotlin.Long, TODO() as kotlin.Int) {
    }
}

final class NXHashTablePrototype public constructor(/*0*/ rawPtr: kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */): kotlinx.cinterop.CStructVar(TODO() as kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */) {
    final var free: kotlinx.cinterop.CPointer<kotlinx.cinterop.CFunction<(kotlinx.cinterop.COpaquePointer? /* = kotlinx.cinterop.CPointer<out kotlinx.cinterop.CPointed>? */, kotlinx.cinterop.COpaquePointer? /* = kotlinx.cinterop.CPointer<out kotlinx.cinterop.CPointed>? */) -> kotlin.Unit>>?
        get() = TODO()
    ...
    final var hash: kotlinx.cinterop.CPointer<kotlinx.cinterop.CFunction<(kotlinx.cinterop.COpaquePointer? /* = kotlinx.cinterop.CPointer<out kotlinx.cinterop.CPointed>? */, kotlinx.cinterop.COpaquePointer? /* = kotlinx.cinterop.CPointer<out kotlinx.cinterop.CPointed>? */) -> platform.posix.uintptr_t /* = kotlin.ULong */>>?
        get() = TODO()
        set(value: kotlinx.cinterop.CPointer<kotlinx.cinterop.CFunction<(kotlinx.cinterop.COpaquePointer? /* = kotlinx.cinterop.CPointer<out kotlinx.cinterop.CPointed>? */, kotlinx.cinterop.COpaquePointer? /* = kotlinx.cinterop.CPointer<out kotlinx.cinterop.CPointed>? */) -> platform.posix.uintptr_t /* = kotlin.ULong */>>?) = TODO()

    final var isEqual: kotlinx.cinterop.CPointer<kotlinx.cinterop.CFunction<(kotlinx.cinterop.COpaquePointer? /* = kotlinx.cinterop.CPointer<out kotlinx.cinterop.CPointed>? */, kotlinx.cinterop.COpaquePointer? /* = kotlinx.cinterop.CPointer<out kotlinx.cinterop.CPointed>? */, kotlinx.cinterop.COpaquePointer? /* = kotlinx.cinterop.CPointer<out kotlinx.cinterop.CPointed>? */) -> kotlin.Int>>?
        get() = TODO()
...
open class Protocol: platform.darwin.NSObject {
constructor(): super(){ TODO() } 
    @kotlinx.cinterop.ObjCMethod(selector = "init", bridge = "objcKniBridge7")open external override /*1*/ fun init(): platform.objc.Protocol?

    companion object Companion: kotlinx.cinterop.ObjCClassOf<platform.objc.Protocol>, platform.objc.ProtocolMeta() {
    }
}

open class ProtocolMeta: platform.darwin.NSObjectMeta {
protected constructor(): super(){ TODO() } 
    @kotlinx.cinterop.ObjCMethod(selector = "alloc", bridge = "objcKniBridge5")open external override /*1*/ fun alloc(): platform.objc.Protocol?

    @kotlinx.cinterop.ObjCMethod(selector = "allocWithZone:", bridge = "objcKniBridge3")open external override /*1*/ fun allocWithZone(/*0*/ zone: kotlinx.cinterop.CPointer<cnames.structs._NSZone>?): platform.objc.Protocol?

    @kotlinx.cinterop.ObjCMethod(selector = "new", bridge = "objcKniBridge1")open external override /*1*/ fun new(): platform.objc.Protocol?
}
...
val NXPtrPrototype: platform.objc.NXHashTablePrototype
    get() = TODO()

val NXPtrStructKeyPrototype: platform.objc.NXHashTablePrototype
    get() = TODO()

val NXStrPrototype: platform.objc.NXHashTablePrototype
    get() = TODO()

val NXStrStructKeyPrototype: platform.objc.NXHashTablePrototype
    get() = TODO()
...
fun NXCompareHashTables(/*0*/ table1: kotlinx.cinterop.CValuesRef<platform.objc.NXHashTable>?, /*1*/ table2: kotlinx.cinterop.CValuesRef<platform.objc.NXHashTable>?): kotlin.Boolean { TODO() }

fun NXCopyHashTable(/*0*/ table: kotlinx.cinterop.CValuesRef<platform.objc.NXHashTable>?): kotlinx.cinterop.CPointer<platform.objc.NXHashTable>? { TODO() }

fun NXCountHashTable(/*0*/ table: kotlinx.cinterop.CValuesRef<platform.objc.NXHashTable>?): kotlin.UInt { TODO() }

fun NXCreateHashTable(/*0*/ prototype: kotlinx.cinterop.CValue<platform.objc.NXHashTablePrototype>, /*1*/ capacity: kotlin.UInt, /*2*/ info: kotlinx.cinterop.CValuesRef<*>?): kotlinx.cinterop.CPointer<platform.objc.NXHashTable>? { TODO() }

fun NXCreateHashTableFromZone(/*0*/ prototype: kotlinx.cinterop.CValue<platform.objc.NXHashTablePrototype>, /*1*/ capacity: kotlin.UInt, /*2*/ info: kotlinx.cinterop.CValuesRef<*>?, /*3*/ z: kotlinx.cinterop.CValuesRef<*>?): kotlinx.cinterop.CPointer<platform.objc.NXHashTable>? { TODO() }

fun NXEmptyHashTable(/*0*/ table: kotlinx.cinterop.CValuesRef<platform.objc.NXHashTable>?) { TODO() }

fun NXFreeHashTable(/*0*/ table: kotlinx.cinterop.CValuesRef<platform.objc.NXHashTable>?) { TODO() }

fun NXHashGet(/*0*/ table: kotlinx.cinterop.CValuesRef<platform.objc.NXHashTable>?, /*1*/ data: kotlinx.cinterop.CValuesRef<*>?): kotlinx.cinterop.COpaquePointer? /* = kotlinx.cinterop.CPointer<out kotlinx.cinterop.CPointed>? */ { TODO() }

fun NXHashInsert(/*0*/ table: kotlinx.cinterop.CValuesRef<platform.objc.NXHashTable>?, /*1*/ data: kotlinx.cinterop.CValuesRef<*>?): kotlinx.cinterop.COpaquePointer? /* = kotlinx.cinterop.CPointer<out kotlinx.cinterop.CPointed>? */ { TODO() }

fun NXHashInsertIfAbsent(/*0*/ table: kotlinx.cinterop.CValuesRef<platform.objc.NXHashTable>?, /*1*/ data: kotlinx.cinterop.CValuesRef<*>?): kotlinx.cinterop.COpaquePointer? /* = kotlinx.cinterop.CPointer<out kotlinx.cinterop.CPointed>? */ { TODO() }

fun NXHashMember(/*0*/ table: kotlinx.cinterop.CValuesRef<platform.objc.NXHashTable>?, /*1*/ data: kotlinx.cinterop.CValuesRef<*>?): kotlin.Int { TODO() }

fun NXHashRemove(/*0*/ table: kotlinx.cinterop.CValuesRef<platform.objc.NXHashTable>?, /*1*/ data: kotlinx.cinterop.CValuesRef<*>?): kotlinx.cinterop.COpaquePointer? /* = kotlinx.cinterop.CPointer<out kotlinx.cinterop.CPointed>? */ { TODO() }

fun NXInitHashState(/*0*/ table: kotlinx.cinterop.CValuesRef<platform.objc.NXHashTable>?): kotlinx.cinterop.CValue<platform.objc.NXHashState> { TODO() }

fun NXNextHashState(/*0*/ table: kotlinx.cinterop.CValuesRef<platform.objc.NXHashTable>?, /*1*/ state: kotlinx.cinterop.CValuesRef<platform.objc.NXHashState>?, /*2*/ data: kotlinx.cinterop.CValuesRef<kotlinx.cinterop.COpaquePointerVar /* = kotlinx.cinterop.CPointerVarOf<kotlinx.cinterop.COpaquePointer /* = kotlinx.cinterop.CPointer<out kotlinx.cinterop.CPointed> */> */>?): kotlin.Int { TODO() }

fun NXNoEffectFree(/*0*/ info: kotlinx.cinterop.CValuesRef<*>?, /*1*/ data: kotlinx.cinterop.CValuesRef<*>?) { TODO() }

fun NXPtrHash(/*0*/ info: kotlinx.cinterop.CValuesRef<*>?, /*1*/ data: kotlinx.cinterop.CValuesRef<*>?): platform.posix.uintptr_t /* = kotlin.ULong */ { TODO() }

fun NXPtrIsEqual(/*0*/ info: kotlinx.cinterop.CValuesRef<*>?, /*1*/ data1: kotlinx.cinterop.CValuesRef<*>?, /*2*/ data2: kotlinx.cinterop.CValuesRef<*>?): kotlin.Int { TODO() }

fun NXReallyFree(/*0*/ info: kotlinx.cinterop.CValuesRef<*>?, /*1*/ data: kotlinx.cinterop.CValuesRef<*>?) { TODO() }

fun NXResetHashTable(/*0*/ table: kotlinx.cinterop.CValuesRef<platform.objc.NXHashTable>?) { TODO() }

fun NXStrHash(/*0*/ info: kotlinx.cinterop.CValuesRef<*>?, /*1*/ data: kotlinx.cinterop.CValuesRef<*>?): platform.posix.uintptr_t /* = kotlin.ULong */ { TODO() }

fun NXStrIsEqual(/*0*/ info: kotlinx.cinterop.CValuesRef<*>?, /*1*/ data1: kotlinx.cinterop.CValuesRef<*>?, /*2*/ data2: kotlinx.cinterop.CValuesRef<*>?): kotlin.Int { TODO() }
...
fun class_addProtocol(/*0*/ cls: kotlinx.cinterop.ObjCClass?, /*1*/ protocol: platform.objc.Protocol): kotlin.Boolean { TODO() }

fun class_conformsToProtocol(/*0*/ cls: kotlinx.cinterop.ObjCClass?, /*1*/ protocol: platform.objc.Protocol?): kotlin.Boolean { TODO() }
...
fun class_copyProtocolList(/*0*/ cls: kotlinx.cinterop.ObjCClass?, /*1*/ outCount: kotlinx.cinterop.CValuesRef<kotlinx.cinterop.UIntVar /* = kotlinx.cinterop.UIntVarOf<kotlin.UInt> */>?): kotlinx.cinterop.CPointer<kotlinx.cinterop.ObjCObjectVar<platform.objc.Protocol?>>? { TODO() }
...
@kotlin.native.SymbolName(name = "platform_objc_kniBridge106")private external fun kniBridge106(/*0*/ p0: kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */, /*1*/ p1: kotlin.UInt, /*2*/ p2: kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */, /*3*/ p3: kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */): kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */

@kotlin.native.SymbolName(name = "platform_objc_kniBridge107")private external fun kniBridge107(/*0*/ p0: kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */, /*1*/ p1: kotlin.UInt, /*2*/ p2: kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */): kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */

@kotlin.native.SymbolName(name = "platform_objc_kniBridge108")private external fun kniBridge108(/*0*/ p0: kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */)

@kotlin.native.SymbolName(name = "platform_objc_kniBridge109")private external fun kniBridge109(/*0*/ p0: kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */)
...
@kotlin.native.SymbolName(name = "platform_objc_kniBridge110")private external fun kniBridge110(/*0*/ p0: kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */)

@kotlin.native.SymbolName(name = "platform_objc_kniBridge111")private external fun kniBridge111(/*0*/ p0: kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */, /*1*/ p1: kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */): kotlin.Byte
...
@kotlin.native.SymbolName(name = "platform_objc_kniBridge113")private external fun kniBridge113(/*0*/ p0: kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */): kotlin.UInt

@kotlin.native.SymbolName(name = "platform_objc_kniBridge114")private external fun kniBridge114(/*0*/ p0: kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */, /*1*/ p1: kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */): kotlin.Int

@kotlin.native.SymbolName(name = "platform_objc_kniBridge115")private external fun kniBridge115(/*0*/ p0: kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */, /*1*/ p1: kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */): kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */

@kotlin.native.SymbolName(name = "platform_objc_kniBridge116")private external fun kniBridge116(/*0*/ p0: kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */, /*1*/ p1: kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */): kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */

@kotlin.native.SymbolName(name = "platform_objc_kniBridge117")private external fun kniBridge117(/*0*/ p0: kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */, /*1*/ p1: kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */): kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */

@kotlin.native.SymbolName(name = "platform_objc_kniBridge118")private external fun kniBridge118(/*0*/ p0: kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */, /*1*/ p1: kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */): kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */

@kotlin.native.SymbolName(name = "platform_objc_kniBridge119")private external fun kniBridge119(/*0*/ p0: kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */, /*1*/ p1: kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */)
...
@kotlin.native.SymbolName(name = "platform_objc_kniBridge120")private external fun kniBridge120(/*0*/ p0: kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */, /*1*/ p1: kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */, /*2*/ p2: kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */): kotlin.Int

@kotlin.native.SymbolName(name = "platform_objc_kniBridge121")private external fun kniBridge121(/*0*/ p0: kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */, /*1*/ p1: kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */): kotlin.ULong

@kotlin.native.SymbolName(name = "platform_objc_kniBridge122")private external fun kniBridge122(/*0*/ p0: kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */, /*1*/ p1: kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */): kotlin.ULong

@kotlin.native.SymbolName(name = "platform_objc_kniBridge123")private external fun kniBridge123(/*0*/ p0: kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */, /*1*/ p1: kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */, /*2*/ p2: kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */): kotlin.Int

@kotlin.native.SymbolName(name = "platform_objc_kniBridge124")private external fun kniBridge124(/*0*/ p0: kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */, /*1*/ p1: kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */, /*2*/ p2: kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */): kotlin.Int

@kotlin.native.SymbolName(name = "platform_objc_kniBridge125")private external fun kniBridge125(/*0*/ p0: kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */, /*1*/ p1: kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */)

@kotlin.native.SymbolName(name = "platform_objc_kniBridge126")private external fun kniBridge126(/*0*/ p0: kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */, /*1*/ p1: kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */)

@kotlin.native.SymbolName(name = "platform_objc_kniBridge127")private external fun kniBridge127(/*0*/ p0: kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */)

@kotlin.native.SymbolName(name = "platform_objc_kniBridge128")private external fun kniBridge128()

@kotlin.native.SymbolName(name = "platform_objc_kniBridge129")private external fun kniBridge129(/*0*/ p0: kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */): kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */
...
@kotlin.native.SymbolName(name = "platform_objc_kniBridge130")private external fun kniBridge130()

@kotlin.native.SymbolName(name = "platform_objc_kniBridge131")private external fun kniBridge131()

@kotlin.native.SymbolName(name = "platform_objc_kniBridge132")private external fun kniBridge132(/*0*/ p0: kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */): kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */

@kotlin.native.SymbolName(name = "platform_objc_kniBridge133")private external fun kniBridge133(/*0*/ p0: kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */): kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */

@kotlin.native.SymbolName(name = "platform_objc_kniBridge134")private external fun kniBridge134(/*0*/ p0: kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */): kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */

@kotlin.native.SymbolName(name = "platform_objc_kniBridge135")private external fun kniBridge135(/*0*/ p0: kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */, /*1*/ p1: kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */): kotlin.ULong

@kotlin.native.SymbolName(name = "platform_objc_kniBridge136")private external fun kniBridge136(/*0*/ p0: kotlin.ULong)

@kotlin.native.SymbolName(name = "platform_objc_kniBridge137")private external fun kniBridge137(/*0*/ p0: kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */): kotlin.Int

@kotlin.native.SymbolName(name = "platform_objc_kniBridge138")private external fun kniBridge138(/*0*/ p0: kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */): kotlin.Int

@kotlin.native.SymbolName(name = "platform_objc_kniBridge139")private external fun kniBridge139(/*0*/ p0: kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */, /*1*/ p1: kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */): kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */
...
@kotlin.native.internal.ExportForCppRuntime(name = "platform_objc_kniBridge140")private fun kniBridge140(/*0*/ p0: kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */): kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */ { TODO() }

@kotlin.native.SymbolName(name = "platform_objc_kniBridge141")private external fun kniBridge141(/*0*/ p0: kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */, /*1*/ p1: kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */, /*2*/ p2: kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */): kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */

@kotlin.native.internal.ExportForCppRuntime(name = "platform_objc_kniBridge142")private fun kniBridge142(/*0*/ p0: kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */, /*1*/ p1: kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */): kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */ { TODO() }

@kotlin.native.SymbolName(name = "platform_objc_kniBridge143")private external fun kniBridge143(/*0*/ p0: kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */, /*1*/ p1: kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */): kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */

@kotlin.native.internal.ExportForCppRuntime(name = "platform_objc_kniBridge144")private fun kniBridge144(/*0*/ p0: kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */): kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */ { TODO() }

@kotlin.native.SymbolName(name = "platform_objc_kniBridge145")private external fun kniBridge145(/*0*/ p0: kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */, /*1*/ p1: kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */): kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */

@kotlin.native.internal.ExportForCppRuntime(name = "platform_objc_kniBridge146")private fun kniBridge146(/*0*/ p0: kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */): kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */ { TODO() }
...
@kotlin.native.SymbolName(name = "platform_objc_kniBridge163")private external fun kniBridge163(): kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */

@kotlin.native.SymbolName(name = "platform_objc_kniBridge164")private external fun kniBridge164(): kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */

@kotlin.native.SymbolName(name = "platform_objc_kniBridge165")private external fun kniBridge165(): kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */

@kotlin.native.SymbolName(name = "platform_objc_kniBridge166")private external fun kniBridge166(): kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */
...
@kotlin.native.internal.ExportForCompiler()@kotlinx.cinterop.ObjCBridge(selector = "new", encoding = "@16@0:8", imp = "knimi_platform_objc0")internal fun objcKniBridge1(/*0*/ kniSC: kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */, /*1*/ kniR: kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */): platform.objc.Protocol? { TODO() }

@kotlin.native.internal.ExportForCompiler()@kotlinx.cinterop.ObjCBridge(selector = "allocWithZone:", encoding = "@24@0:8^{_NSZone=}16", imp = "knimi_platform_objc2")internal fun objcKniBridge3(/*0*/ kniSC: kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */, /*1*/ kniR: kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */, /*2*/ zone: kotlinx.cinterop.CPointer<cnames.structs._NSZone>?): platform.objc.Protocol? { TODO() }

@kotlin.native.internal.ExportForCompiler()@kotlinx.cinterop.ObjCBridge(selector = "alloc", encoding = "@16@0:8", imp = "knimi_platform_objc4")internal fun objcKniBridge5(/*0*/ kniSC: kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */, /*1*/ kniR: kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */): platform.objc.Protocol? { TODO() }

@kotlin.native.internal.ExportForCompiler()@kotlinx.cinterop.ObjCBridge(selector = "init", encoding = "@16@0:8", imp = "knimi_platform_objc6")internal fun objcKniBridge7(/*0*/ kniSC: kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */, /*1*/ kniR: kotlinx.cinterop.NativePtr /* = kotlin.native.internal.NativePtr */): platform.objc.Protocol? { TODO() }

fun objc_addExceptionHandler(/*0*/ fn: platform.objc.objc_exception_handler? /* = kotlinx.cinterop.CPointer<kotlinx.cinterop.CFunction<(kotlin.Any?, kotlinx.cinterop.COpaquePointer? /* = kotlinx.cinterop.CPointer<out kotlinx.cinterop.CPointed>? */) -> kotlin.Unit>>? */, /*1*/ context: kotlinx.cinterop.CValuesRef<*>?): platform.posix.uintptr_t /* = kotlin.ULong */ { TODO() }
...
fun objc_allocateProtocol(/*0*/ name: kotlin.String?): platform.objc.Protocol? { TODO() }
...
fun objc_copyProtocolList(/*0*/ outCount: kotlinx.cinterop.CValuesRef<kotlinx.cinterop.UIntVar /* = kotlinx.cinterop.UIntVarOf<kotlin.UInt> */>?): kotlinx.cinterop.CPointer<kotlinx.cinterop.ObjCObjectVar<platform.objc.Protocol?>>? { TODO() }
...
fun objc_getProtocol(/*0*/ name: kotlin.String?): platform.objc.Protocol? { TODO() }

fun objc_registerProtocol(/*0*/ proto: platform.objc.Protocol) { TODO() }

fun objc_removeExceptionHandler(/*0*/ token: platform.posix.uintptr_t /* = kotlin.ULong */) { TODO() }
...
fun protocol_addMethodDescription(/*0*/ proto: platform.objc.Protocol, /*1*/ name: kotlinx.cinterop.CValuesRef<*>?, /*2*/ types: kotlin.String?, /*3*/ isRequiredMethod: kotlin.Boolean, /*4*/ isInstanceMethod: kotlin.Boolean) { TODO() }

fun protocol_addProperty(/*0*/ proto: platform.objc.Protocol, /*1*/ name: kotlin.String?, /*2*/ attributes: kotlinx.cinterop.CValuesRef<platform.objc.objc_property_attribute_t>?, /*3*/ attributeCount: kotlin.UInt, /*4*/ isRequiredProperty: kotlin.Boolean, /*5*/ isInstanceProperty: kotlin.Boolean) { TODO() }

fun protocol_addProtocol(/*0*/ proto: platform.objc.Protocol, /*1*/ addition: platform.objc.Protocol) { TODO() }

fun protocol_conformsToProtocol(/*0*/ proto: platform.objc.Protocol?, /*1*/ other: platform.objc.Protocol?): kotlin.Boolean { TODO() }

fun protocol_copyMethodDescriptionList(/*0*/ proto: platform.objc.Protocol, /*1*/ isRequiredMethod: kotlin.Boolean, /*2*/ isInstanceMethod: kotlin.Boolean, /*3*/ outCount: kotlinx.cinterop.CValuesRef<kotlinx.cinterop.UIntVar /* = kotlinx.cinterop.UIntVarOf<kotlin.UInt> */>?): kotlinx.cinterop.CPointer<platform.objc.objc_method_description>? { TODO() }

fun protocol_copyPropertyList(/*0*/ proto: platform.objc.Protocol, /*1*/ outCount: kotlinx.cinterop.CValuesRef<kotlinx.cinterop.UIntVar /* = kotlinx.cinterop.UIntVarOf<kotlin.UInt> */>?): kotlinx.cinterop.CPointer<platform.objc.objc_property_tVar /* = kotlinx.cinterop.CPointerVarOf<platform.objc.objc_property_t /* = kotlinx.cinterop.CPointer<cnames.structs.objc_property> */> */>? { TODO() }

fun protocol_copyPropertyList2(/*0*/ proto: platform.objc.Protocol, /*1*/ outCount: kotlinx.cinterop.CValuesRef<kotlinx.cinterop.UIntVar /* = kotlinx.cinterop.UIntVarOf<kotlin.UInt> */>?, /*2*/ isRequiredProperty: kotlin.Boolean, /*3*/ isInstanceProperty: kotlin.Boolean): kotlinx.cinterop.CPointer<platform.objc.objc_property_tVar /* = kotlinx.cinterop.CPointerVarOf<platform.objc.objc_property_t /* = kotlinx.cinterop.CPointer<cnames.structs.objc_property> */> */>? { TODO() }

fun protocol_copyProtocolList(/*0*/ proto: platform.objc.Protocol, /*1*/ outCount: kotlinx.cinterop.CValuesRef<kotlinx.cinterop.UIntVar /* = kotlinx.cinterop.UIntVarOf<kotlin.UInt> */>?): kotlinx.cinterop.CPointer<kotlinx.cinterop.ObjCObjectVar<platform.objc.Protocol?>>? { TODO() }

fun protocol_getMethodDescription(/*0*/ proto: platform.objc.Protocol, /*1*/ aSel: kotlinx.cinterop.CValuesRef<*>?, /*2*/ isRequiredMethod: kotlin.Boolean, /*3*/ isInstanceMethod: kotlin.Boolean): kotlinx.cinterop.CValue<platform.objc.objc_method_description> { TODO() }

fun protocol_getName(/*0*/ proto: platform.objc.Protocol): kotlinx.cinterop.CPointer<kotlinx.cinterop.ByteVar /* = kotlinx.cinterop.ByteVarOf<kotlin.Byte> */>? { TODO() }

fun protocol_getProperty(/*0*/ proto: platform.objc.Protocol, /*1*/ name: kotlin.String?, /*2*/ isRequiredProperty: kotlin.Boolean, /*3*/ isInstanceProperty: kotlin.Boolean): platform.objc.objc_property_t? /* = kotlinx.cinterop.CPointer<cnames.structs.objc_property>? */ { TODO() }

fun protocol_isEqual(/*0*/ proto: platform.objc.Protocol?, /*1*/ other: platform.objc.Protocol?): kotlin.Boolean { TODO() }
